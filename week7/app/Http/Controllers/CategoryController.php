...
class CategoryController extends Controller
{
    ...
    public function showTotalStockEachCategory()
    {
        //sql 
        // SELECT c.id, c.category Count(p.stok) FROM categories c INNER JOIN products p ON c.id = p.category_id GROUP BY c.id
    }
}
