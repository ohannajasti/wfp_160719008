      ...
      <table class="table table-bordered table-hover datatable-hamdi" id="table_kategori">
        ...
        <tbody> 
          ...
          <tr>
            ...
            <td>       
              <a class="btn btn-info" data-toggle="modal" href="#modal_list_produk" onclick="showDetailTransaksi({{ $d->id }})">
                List Produk
              </a>
            </td>
          </tr> 
...
@section('tempat_script')
  <script> 
    ...
    function showDetailTransaksi(id_transaksi) 
    {
        $('#modal_body_list_produk').html('Sedang memuat data ....');
        $.post('{{route("transaction.showDetailTransaksi")}}',
        {
