		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
                ...
                <li class="start active ">
					<a href="/academicbook">
					<i class="icon-home"></i>
					<span class="title">Academic Book</span>
					<span class="selected"></span>
					</a>
				</li>
				<li class="start active ">
					<a href="/report/comics/request">
					<i class="icon-home"></i>
					<span class="title">Comic request</span>
					<span class="selected"></span>
					</a>
				</li>
                <li class="start">
					...
					<ul class="sub-menu" style="display: none;">
						<li>
							<a href="/report/pelajaran/request">
							<i class="icon-anchor"></i>
							Pelajaran</a>
						</li>
                        <li>
							<a href="/report/novel/request">
							<i class="icon-anchor"></i>
							Novel</a>
						</li>
                        <li>
							<a href="/report/komik/request">
							<i class="icon-anchor"></i>
							Komik</a>
						</li>
